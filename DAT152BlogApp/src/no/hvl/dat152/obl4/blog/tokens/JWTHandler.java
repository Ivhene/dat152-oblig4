...
public class JWTHandler {
	...
	private static PublicKey loadPublicKey(String path) {
		...
		try {
			...
			System.err.println("Invalid key format or algorithm.");
		} catch (IOException e) {
			System.err.println("Error reading the public key file.");
		} catch (Exception e) {
			System.err.println("Unexpected error loading the public key.");
		}
	...
	private static String readKeys(String path) throws IOException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader(path))) {
			...
			throw new IOException("Error reading the public key file.");
		}
